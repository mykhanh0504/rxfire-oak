...
Acorn germination rates increased in at least 3 years folllowing the burns; pair 1 specifically experienced five years of substantially more germination in the burned stand versus the control stand (@fig-germination). Seedling density in 2023 was three times greater in burned stands (2887±240 per ha) than in control stands (1030±154 per ha, p\<0.001) (@fig-merged a). Seedlings in burned stands also grew better than in control stands, evidenced by greater DRC in 2023 (4.6±0.3 mm versus 3.3±0.3 mm, p\<0.01) (@fig-merged b), greater extension growth in 2024 (6.43±0.5 cm versus 2.6±0.4 cm, p\<0.001) (@fig-merged c), and more leaves sprouted (16±1 versus 7±1, p\<0.001) (@fig-merged d).

![Acorn germination rates before and following burn years, which are indicated by the red dashed lines.](graphs/germ.jpg){#fig-germination fig-align="center"}
...
*Q. rubra* seedling density in burned stands is nearly triple that in control stands, supporting the hypothesis that prescribed fire promotes seedling recruitment (@fig-merged a). We did not find any significant effect the different cutting treatments may have had on such recruitment; though the cuttings were of different intensities and took place at different years, complicating the comparison. When these cutting treatments took place, management left behind mostly *Q. rubra* trees in the highest DBH size classes, 30 cm and above (@fig-overstory). The mother trees survived the burns better than their mesophytic competitors (Appendix, Table 1) and continued to reproduce while their competition took time to regrow. Only 3% of *Q. rubra*'s basal area in 2023 was made up by dead standing mature trees, as opposed to 43% by dead *F. grandifolia* individuals. Their survival rates are higher potentially due to thicker bark and rapid compartmentalization, among other factors [@deyReviewDynamicsPrescribed2018]. Furthermore, there is evidence that acorn production is positively correlated to tree vigor i.e full-crowned dominant trees of larger DBHs produce more acorns [@bogdziewicz2020]. Even though acorn production is also dependent on tree genetics [@smith2022], meaning that “good” producers are more likely to yield larger crops, thinning and burning to release the healthiest-looking individuals raises the chance of achieving better yields. In our study, acorn germination rates only greatly increased following the burn events and continued for up to five years (@fig-germination). It can interpreted that burned stands were having larger acorn yields and, also, that these stands possessed qualities that better enable the germination process itself.

One such quality could be the altered soil resource supply by fire. Fire increases gross nitrogen mineralization rate, which in turns releases more of it into the soil [@chapin2012]. A sudden increase in nitrogen availability in the nitrogen-limited temperate forest [@vadeboncoeur2010] may help promote flowering and acorn production [@callahan2008]. However, fire decreases microbial nitrate immobilization and subsequently inhibit nitrate retention [@su2022]. As a result, nitrous oxide and nitric oxide emissions rise following a burn and become lost permanently from the ecosystem rather than being tightly recycled in decomposition [@stephens2023]. While such emissions tend to last under a year, nitrogen loss by leaching can persist in the long term [@zhu2024]. Our study burns were already at least two years old at the time of data collection, except for the wildfire in pair 4 that had occurred the previous year. Regardless, the short term increases in ammonium concentrations in the soils seemed to have diminished for all but pairs 2 and 6 (Appendix, Figure 3). Nitrate concentrations are minimal compared to ammonium, but they were similar for both burned and control stands across all pairs, signaling that leaching might not be of great concern in this ecosystem (Appendix, Figure 4).

In terms of acorn germination success, fire is assumed to decrease acorn herbivory, which can lead to nonviable seeds or low-vigor seedlings, by interfering with insects’ life cycle portions spent in the soil [@riccardi2004]. For example, weevils (*Conotrachelus spp.* and *Curculio spp.*) and could be killed by fire while exiting from fallen acorns or while in the forest floor layers attempting to reach the soil. Fire consumption of the forest floor removes their hiding areas and presents them to greater predation by small mammals. Another benefit fire provides is lessening the litter thickness and increasing bare soil surfaces, which in turns aids root penetration and avoids long and weak stems growing through thick litter [@hutchinson2024]. Percent bare soil in this study, however, did not correlate with seedling density (Appendix, Figure 1). We also explored whether interactions between fire and microtopography could be beneficial to *Q. rubra* regeneration e.g., a concave microsite can accumulate acorns as well as leaf litter, and fire can help consume such litter, but no patterns of advantage were observed in the burned stands (Appendix, Figure 2).

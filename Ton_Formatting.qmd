...
Northern red oak (*Quercus rubra* L.) is an economically and ecologically important tree species in the northeastern United States. It is a fast-growing species and thrives on a wide range of upland soils [@abramsFireDevelopmentOak1992]. It is tolerant of heat, drought [@coble2017; @asbjornsen2021], and ground fire [@abramsFireEcologicalHistory2000]. *Q. rubra* produces high-quality timber with high wood density, making it an important lumber commodity and prompting forest managers across its range to be concerned with its sustainable regeneration [@deyReviewDynamicsPrescribed2018]. *Q. rubra* is managed for other ecological values as well. For example, it serves as a habitat and food source for many wildlife species, from birds like turkeys and jays to mammals like mice, squirrels, and deer, and even insects like weevils [@mcsheaForestryMattersDecline2007]. Acorns have become a major hard mast source for wildlife consumption since the demise of American chestnut. Acorn mast production, occurring about every two years, plays a critical role in driving the population dynamics of these animals [@sork1993].

*Q. rubra* currently faces many regeneration challenges in the northeastern US, and its recruitment may continue failing without timely and appropriate interventions because acorn production declines as stands age [@mcewan2006]. Oak-dominated forests are at their peak capacity to produce acorns at present; however, if forest aging continued for the next 50 years without sufficient regeneration to maintain its age structure, a population bottleneck may ensue [@dey2014]. Weevils can also make the acorns non-viable before they are fully mature. This high seed predation strongly limits successful advance regeneration outside of mast years [@mcsheaForestryMattersDecline2007]. Moreover, seedling root penetration into underlying soils can be hindered by thick litter layers and can result in long and weak stems [@arthurRefiningOakFireHypothesis2012]. Even when seedlings are established, they risk being consumed, especially by deer [@mcsheaForestryMattersDecline2007]. Deer browse impact is among the strongest predictors of regeneration abundance [@miller2023], and can weaken effects of disturbances such as fire and large canopy gaps [@nuttle2013]. *Q. rubra* is also susceptible to some fungal pathogens later in its life cycle including *Bretziella fagacearum* and *Armillaria mellea*, which cause oak wilt and Armillaria root rot, respectively. While the former disease is spread from tree to tree through root grafts and travels longer distances by sap beetles (*Nitidulidae*) and bark beetles (*Pseudopityophthorus spp.*), the latter grows parasitically on trees weakened by fire, drought, insects, or other diseases [@sander1990]. Lastly, its relative shade intolerance retards its seedling recruitment when there is insufficient light in the understory [@nowackiDemiseFireMesophication2008]. Seedling growth under an intact or thinned canopy might be slow due to competition from more shade-tolerant species such as red maple (*Acer rubrum*) and American beech (*Fagus grandifolia*). 

@abramsFireDevelopmentOak1992 hypothesized that ground fire might be crucial for oak regeneration. Fire has been integral to upland oak systems in the eastern US for millennia, evidenced by the co-presence of charcoal and oak dominance. Pre-settlement fires occurred as a function of lightning strikes as well as Native American activities such as cooking, heating, seedbed preparation, hunting, ceramic manufacture, and communication [@nowacki2024]. European settlement continued the periodic burning; furthermore, they spent the first half of the 19^th^ century clearing land for agriculture, then the second half abandoning such farmland [@foster1992]. Abandoned fields quickly became white pine-dominated forests (*Pinus strobus*), which was promptly logged as timber. *Q. rubra* was released from the understory and eventually emerged as the dominating species in the mid-20^th^ century [@nowackiDemiseFireMesophication2008]. Oak recruitment, however, sharply declined shortly afterward as forests became wetter and more shady [@goodale1997]. Implementation of aggressive federal fire suppression efforts, combined with land conversion and overgrazing legacies, started to promote forest mesophication. Mesic microenvironmental conditions in turn favored the regeneration of shade-tolerant species. This positive feedback loop shrinks suitable habitats for shade-intolerant, fire-adapted species like *Q. rubra* over time. Therefore, it has been argued that it may be necessary to bring back fire in a controlled manner to reverse the feedback loop and restore the upland oak ecosystems in the northeastern landscape [@abramsFireDevelopmentOak1992].

The other important consideration for oak regeneration is that *Q. rubra* distribution is projected to move further northward due to climate change [@petersClimateChangeTree2020]. Out of all *Quercus* species native to North America, it is the one with the most northern distribution. Previously, it was pushed southward to its modern-day distributions during the Eocene-Oligocene climate transition 34 million years ago due to a 3-5^o^C decrease in temperature at high latitudes [@hipp2018]. However, its potential distribution is now projected to increase substantially in New England by 2100, particularly in northern New York, Vermont, New Hampshire, and Maine, under both representative concentration pathways (RCP) 4.5 and 8.5 due to high adaptability to a changing climate [@peters2020]. This presents an opportunity for foresters, landowners, and scientists with an interest in introducing or increasing *Q. rubra* density as part of their species mix at or beyond its current range limit as a timber producing species [@cogbill2002; @vadeboncoeur2012]. Adaptive silviculture can be implemented to facilitate this transition and contribute towards long-term resilience on the stand level [@nagel2017]. Adding another species like *Q. rubra* to stands without species that have similar traits can increase an ecosystem's functional diversity, potentially stabilizing it and mitigating future stresses and disturbances such as drought impacts [@yuan2025]. Silvicultural methods range from different ways of thinning and artificial planting to prescribed burns and combinations of them. Since oaks have little commercial value until they reach a diameter at breast height (DBH) of 30 cm, regeneration strategies need to be lengthy processes to ensure its establishment, development of advanced regeneration to 1.4 m, and release [@desmarais1998]. Syncing forest operations with nature's timing is another important consideration. For example, it might be sensible to do shelterwood cutting, during which a portion of the overstory is removed to establish the next cohort of regenerating seedlings of desired species, during bareground seasons to scarify the soil and bury acorns below the soil surface. Many previous studies have demonstrated that fire, alone or when combined with thinning, strengthens or re-establishes its dominance in different ecosystems through a combination of greater relative fire resistance and easing other regeneration limitations [@iverson2008; @granger2018; @bassett2020; @dee2022].

This study investigates whether prescribed fire promotes the recruitment of *Q. rubra* seedlings and improves their growth relative to forest management practices such as shelterwood or seed-tree harvests alone. We studied six pairs of burn and control forest stands across the White Mountains ecoregion in New Hampshire, USA. Three pairs were intentionally harvested and prescribed burn treatments applied with the objective of improving oak regeneration. Two other pairs lack an oak seed source but can provide insights into northern hardwood regeneration dynamics following prescribed burns. The last pair was unmanaged and experienced a wildfire instead, making it a fitting comparison. We hypothesized that *Q. rubra* regenerates more successfully in burn stands, both quantitatively and qualitatively.

# Methods

## Study sites

The six pairs of burn and control forest stands selected for this study are located in the approximately 320,000-ha White Mountains National Forest (WMNF) in New Hampshire (USA), three of which are part of a novel landscape-scale project guided by the WMNF's Land and Resource Management Plan (1999-2005, [@usdaforestservice2005]) and implemented by the USFS over the past two decades (Appendix, Figures 1-4). Stands are paired by project and treatment date, with one stand harvested and the paired site harvested and burned (@tbl-pairs, @fig-map). One pair does not have any recent management history, but was sampled opportunistically following a wildfire that resulted in patchy mortality of canopy trees in a mature stand. The remaining two pairs at Bartlett Experimental Forest were burned to study how a combination of clearcut and prescribed fire can impact overall tree regeneration. While we observed a few *Q. rubra* seedlings in the surrounding forest stands and even burned acorns in the study stands, no local seed source was apparently present after the treatments. Mature trees were presumed to be harvested during the clearcuts. We collected data from these stands to compare oak regeneration success among different harvest treatments and their combinations with prescribed burns.
...
In summer 2023, transects (50 -225 m long) were laid 30 to 50 m apart to sample the variety of light and soil conditions in each study stand. Along each transect is a series of 1 m² quadrats (hereafter referred to as “plots”) spaced 10 m apart from their centers. In total, there were 43 transects laid in 6 pairs of burn-control stands, with a total of 393 plots. Percent slope, aspect, microtopography, burn evidence, and *Q. rubra* litter presence were recorded for each plot. Slope was measured with a hypsometer and later validated with topographical maps, and aspect with a compass. Microtopography was described qualitatively and burn evidence at the plot scale was confirmed with charcoal presence under the litter layer. Surface cover was estimated in categories including bare soil, woody debris, leaf litter, and rock. Live vegetation cover below breast height was also estimated visually. Woody species with DBH smaller than 2 cm were identified and their stems counted.

In July-August 2024, leaf area index (LAI) measurements were made at the center of each plot as a metric of light availability. The LAI-2200C Plant Canopy Analyzer (Licor, Lincoln, NE, USA) was positioned at \~50 cm height to assess the light availability to seedlings. LAI data were then matched temporally, calibrated, and analyzed using the LI-COR FV2200 software [@rhoads2004].

### Seedling measurements and sample collection

In summer 2023, any *Q. rubra* seedlings present in the 1 m^2^ plots were marked using aluminum embossable tags, aged, measured for height (cm) and diameter at root collar (DRC, mm), and checked for evidence of herbivory and pathogen damage. In summer 2024, they were resurveyed twice, once in June and again in August, to quantify growth between the two growth seasons and within this season alone. At this time, we also counted the number of leaves and number of live and dead branches. Herbivory and pathogen damage were quantified by percent of leaf area impacted as well as described qualitatively. 

Within a 5-m radius of each plot center, all trees \>2 cm DBH were identified and measured. The number of *Q. rubra* seedlings was also counted. In summer 2024, seedling abundance was re-estimated twice, once at the beginning and again at the end of the season.
...
# Step 1: Get top 3 species per Pair + Disturbance
top_species <- count %>%
  group_by(Pair, Disturbance, Spcode) %>%
  summarise(total_stemcount = sum(stemcount), .groups = 'drop') %>%
  group_by(Pair, Disturbance) %>%
  slice_max(total_stemcount, n = 3, with_ties = FALSE) %>%
  ungroup()

# Step 2: Keep union of those species within each Pair (ignore Disturbance)
species_union <- top_species %>%
  distinct(Pair, Spcode)

# Step 3: Filter count to only those species
filtered_count <- count %>%
  semi_join(species_union, by = c("Pair", "Spcode"))

#count <- count %>% group_by(Pair, Disturbance) %>% slice_max(stemcount,n=3)
...
count2 <- count %>% group_by(Pair,Disturbance) %>% 
...
count2 %>% 
  ggplot(aes(x=Pair,y=total_density,fill=Disturbance))+
  geom_rect(aes(fill=Pair),alpha=0.5,
            xmin=-Inf, xmax=Inf, ymin=-Inf, ymax=Inf)+
  scale_fill_manual(values=p6,name="Pairs")+
  new_scale_fill()+
  geom_col(aes(fill=Disturbance),width=0.6,position=position_dodge(width=0.7))+
  scale_fill_manual(values=bc,name="Disturbance")+
  facet_grid(~Pair,scales='free_x')+
  theme_minimal()+
  ylab("Total woody stem count (per m2)")
...
ggplot(aes(x=Spcode,y=Density))+
  ...
  xlab("Species")+
  ylab("Stem count (per m2)")
```

Study stands' basal areas reflect past harvesting methods more than whether or not they were burned (@fig-overstory). Having been clearcut more recently and hence absent of trees with DBH of 20 cm and above, Pairs 5 and 6 have effectively zero basal area compared to others with 18.3 (burned stand in Pair 2) to 37.9 m^2^ (burned stand in Pair 1). Their compositions are also the least diverse, consisting of cherries (*Prunus*), aspens (*Populus*), and *Betula spp*. The remaining stands have a significant presence of mature *Q. rubra* as well as *Acer* and *Betula* *spp*. of mid-range DBH classes. Additionally, Pair 1's overstory composition includes a large basal area of high-DBH *P. strobus*, though only made up by a few individual trees. *Q. rubra*'s basal areas averaged 11±2 m^2^/ha across all stands, far exceeding those of other dominant genera (Appendix, Table 1). More standing dead trees were recorded in the burned stands, with *F. grandifolia* suffering the highest mortality rate (43% of basal area occupied by dead trees).
...
![Approximate germination years of living seedlings in 2023; burn years are indicated by the red dashed lines.](graphs/germ.jpg){#fig-germination fig-align="center" width="1087"}

![a. (top left) Q. rubra density per hectare in 2023; b. (top right) Seedling diameters at root collar in 2023; c. (bottom left) Seedling extension growth in 2024; d. (bottom right) Number of leaves per seedling in 2024 by stand pairs, error bars = ±1 SE.](graphs/Ton_figmerge.jpg){#fig-merged fig-align="center"}
...
```{r fig-count23,include=TRUE,echo=FALSE,warning=FALSE,fig.cap="Q. rubra seedling density per hectare in 2023 (y-axis) by stand pairs (x-axis), error bars = ±1 SE.",fig.width=6,fig.pos="H"}
#visualize stem density
...
*Q. rubra* regeneration can be promoted by prescribed burns at any and all critical life stages including acorn production, germination, establishment, seedling development, and canopy release [@arthurRefiningOakFireHypothesis2012]. First of all, oak mother trees survive fire better than their mesophytic competitors (Appendix, Table 1) with thicker bark and rapid compartmentalization [@deyReviewDynamicsPrescribed2018]. Only 3% of *Q. rubra*'s basal area in 2023 was made up by dead standing mature trees, as opposed to 43% by dead *F. grandifolia* individuals. They hence have a time advantage to continue reproducing while their competition required more time to re-establish from seed and regrow. Moreover, there is evidence that acorn production is positively correlated to tree vigor i.e full-crowned dominant trees of larger DBHs produce more acorns [@bogdziewicz2020]. Even though acorn production is also dependent on tree genetics [@smith2022], meaning that “good” producers are more likely to yield larger crops with or without fire, thinning and burning to release the healthiest individuals raises the chance of achieving better yields. This is in line with the shelterwood and seed tree cuttings in Pairs 1-3, where management left behind mostly *Q. rubra* trees in the highest DBH size classes, 30 cm and above (@fig-overstory).

In terms of acorn germination success, fire is assumed to decrease acorn predation, which can lead to nonviable seeds or low-vigor seedlings, by interfering with insects’ life cycle portions spent in the soil [@riccardi2004]. For example, weevils (*Conotrachelus spp.* and *Curculio spp.*) and could be killed by fire while exiting from fallen acorns or while in the forest floor layers attempting to reach the soil. Fire consumption of the forest floor removes their hiding areas and presents them to greater predation by small mammals. Another benefit fire provides is reducing the litter thickness and increasing bare soil surfaces, which in turns aids root penetration and avoids long and weak stems growing through thick litter [@hutchinson2024]. Percent bare soil in this study, however, did not correlate with seedling density at the plot scale (Appendix, Figure 5). We also explored whether interactions between fire and microtopography affected *Q. rubra* regeneration. For example, acorn accumulation may occur in a concave microsite and increase the germination probability here. However, the concave microsite can also gather germination barriers like leaf litter and rain water. Fire can consume litter and lessen soil moisture, but no patterns of advantage were observed in the burned stands (Appendix, Figure 6).

While no pre-treatment data exists for this study to directly answer the question of whether burned stands experienced larger acorn yields or greater germination rates, the majority of the living *Q. rubra* seedlings in 2023 germinated in the 3-5 years following the burn events, indicating that the prescribed fire had a greater effect on oak seedling recruitment than the thinning harvests alone (@fig-germination). Furthermore, after 2-6 years, the seedling density in burned stands itself is nearly triple that in control stands, supporting the hypothesis that prescribed fire promotes seedling recruitment (@fig-merged a). One of the potential mechanisms of accelerating this recruitment is altered soil resource supply by fire. Fire increases gross nitrogen mineralization rate, which in turns releases more of it into the soil [@chapin2012]. A sudden increase in nitrogen availability in the nitrogen-limited temperate forest [@vadeboncoeur2010] may help promote flowering and acorn production [@callahan2008]. However, fire decreases microbial nitrate immobilization and subsequently inhibit nitrate retention [@su2022]. As a result, nitrous oxide and nitric oxide emissions rise following a burn and become lost permanently from the ecosystem rather than being tightly recycled in decomposition [@stephens2023]. While such emissions do not usually continue beyond the first year, nitrogen loss by leaching can persist in the long term and up to a 308% rate of change [@zhu2024]. Our study burns were already at least two years old at the time of data collection, except for the wildfire in pair 4 that had occurred the previous year. Regardless, the short term increases in ammonium concentrations in the soils seemed to have diminished for all but pairs 2 and 6 (Appendix, Figure 7). Nitrate concentrations are minimal compared to ammonium, but they were similar for both burned and control stands across all pairs, signaling that leaching might not be of great concern in this ecosystem in our study (Appendix, Figure 8).

## *Q. rubra* seedling growth promoted by prescribed fires

Diameter at root collar, extension growth, and number of leaves were significantly greater for *Q. rubra* seedlings in burned stands versus control stands (@fig-merged b, c, d). While mesophytic competitors experience dieback and invest their resources in regrowth, *Q. rubra* seedlings can immediately take advantage of the increased nutrients, space, and light (@fig-lai) to grow taller vertically and horizontally as well as produce leaves to expedite photosynthesis. Additionally, because available nitrogen pools [@wan2001] and fluxes [@wang2014] can remain elevated for up to a year after burn events, the oak seedlings may have benefited from post-fire increases in nutrient availability. On the other hand, the significantly larger annual extension growths and leaf production in the past two summers imply that the positive fire effects still linger 3-7 years post-treatment. It is also possible that their continued growth was primarily related to the high light conditions in the open environments and their well-established root systems after that first year of growth and nutrient pulses.

It is also worth evaluating fire effects on competitors at the germination and seedling establishment stage. Fire can reduce seed bank abundance [@schuler2010], but it is more likely that the seed bank remains plentiful, especially in cases where the burn was of low or patchy intensity. In the understory, early successional seedlings were plentiful, mostly comprising *Rubus spp.*, *A. rubrum*, and *Betula spp.* (@fig-understory). *Rubus* seeds are dispersed by birds and mammals that survive in the soil when buried [@zasada2008]. The latter two do not survive well in the soil when a prescribed burn takes place but, if mature trees survived the fire or are present in an adjacent unburned forest, they are capable of producing high volumes of wind-dispersed seeds that germinate well in the postfire exposed mineral soil [@walters1990; @erdmann1990]. On the other hand, acorns neither survive in the soil for multiple years nor disperse far [@sander1990]. Nevertheless, *Q. rubra* has comparably strong basal sprouting responses following the death of the main stem, much like *A. rubrum* and *F. grandifolia* [@tubbs1990].

Prescribed fire can only be considered an effective management tool for *Q. rubra* regeneration if the net effects are positive. This means doing less damage to our target species than its existing competitors, and promote its regeneration over them. Our study demonstrates such positive effects for both oak recruitment and establishment near its northern range limit in North America and affirms prescribed fire as a potentially beneficial silvicultural management tool in facilitating the species' establishment north of its current distribution and ensuring forest resiliency in time of climate change. Future work should focus on improving understanding of how belowground variables are affected by prescribed fire and, in turn, influence oak regeneration dynamics. *Q. rubra* is known to allocate more resources belowground in the first few years than aboveground [@kolb1990]. While destructive harvesting of seedlings was beyond the scope of this research, knowledge on their belowground structures would have provided a more comprehensive understanding of what role fire plays in resource allocation. Other mechanisms at play, especially fire-soil interactions, can further illuminate how fire influences nutrient pools and fluxes as well as mycorrhizal fungal colonization and soil microbial communities. Lastly, while this study only discusses seed-based regeneration, *Q. rubra* also possesses prolific sprouting capabilities. Coppicing regeneration generally remains a research gap [@liu2025], and developing a systematic comparison between the two mechanisms will provide a more comprehensive picture of its regeneration potential in the ecosystem.
